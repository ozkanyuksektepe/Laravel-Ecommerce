                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="adres" id="adres" value="{{ auth()->user()->adres }}" required>
                            </div>
                    </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telefon" name="telefon" id="telefon" value="{{ auth()->user()->telefon }}" required>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="ceptelefonu">Cep Telefonu</label>
                                    <input type="text" class="form-control telefon" name="ceptelefonu" id="ceptelefonu" value="{{ auth()->user()->ceptelefonu }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
